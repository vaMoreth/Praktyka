...
def generate():
    ...
    process_elements(document, doc_number, issue_date, course, name, start_date, end_date)
...
def process_elements(document, doc_number, issue_date, course, name, start_date, end_date):
    for paragraph in document.paragraphs:
        replace_placeholders(paragraph, doc_number, issue_date, course, name, start_date, end_date)


def replace_placeholders(paragraph, doc_number, issue_date, course, name, start_date, end_date):
    text = paragraph.text
    ...
    daysObj = end_date_obj - start_date_obj
    ...
    text = re.sub(r'\{\{days\}\}', str(daysObj.days), text)
